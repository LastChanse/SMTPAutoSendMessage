...
>#### Подготовка
>Для работы сборщика [скачайте](https://download.oracle.com/java/19/archive/jdk-19_windows-x64_bin.zip) jdk 19 и переместите всё содержимое папки (находящейся в архиве) в папку jdk-19.0.
...
### Как работает?
* Чтобы отправить файлы необходимо загрузить их в папку "sendingFiles"
...
* Заполнить или изменить параметры письма
